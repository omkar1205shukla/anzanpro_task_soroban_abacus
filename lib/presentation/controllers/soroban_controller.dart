...
//       // Find beads for this column
//       final upperBead = beads.firstWhere((b) => b.column == col && b.isUpper);
//       final lowerBeads = beads.where((b) => b.column == col && !b.isUpper);

//       if (upperBead.isActive) colValue += 5;
//       colValue += lowerBeads.where((b) => b.isActive).length;
